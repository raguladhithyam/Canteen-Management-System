  ...
  var firebaseConfig = {
    apiKey: "AIzaSyDHRM8UBkyYdkyBqFHe44Clu6ZXd8jDntQ",
    authDomain: "rdcd-10bdc.firebaseapp.com",
    projectId: "rdcd-10bdc",
    storageBucket: "rdcd-10bdc.appspot.com",
    messagingSenderId: "929458490655",
    appId: "1:929458490655:web:f829698cf897575a80f42a"
  };
  ...
  class signUpMethods {
    ...
    static authRedirecting() {
      window.setTimeout(() => {
        window.location.replace('client-side');
      }, 500)
    }
