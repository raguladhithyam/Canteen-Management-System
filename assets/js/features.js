    ...
    previewNavbar.innerHTML = `
        <div class="container flex text-center jc-ai-center">
            ...
            <div class="site-title flex align-item-center">
                <div>
                    <a href="index.html"><h1><span class="clr-red">RD</span> <span class="clr-green">Canteen</span></h1></a>
                </div>
                <!-- Toggle Bars -->
...
if (signUpModal){
    ...
    <div class="modal-container">
        ...
        <div class="modal-content">
            <div class="md">Welcome to <br><span class="clr-red md">RD</span> <span class="clr-green md">Canteen</span></div>
            ...
            <!-- Upper Footer -->
                <main class="grid grid-3">
                    ...
                    <article class="about">
                        ...
                        <p>RD Canteens offer a delightful culinary experience, serving a diverse range of delectable dishes to satisfy every palate. With a commitment to quality and freshness, these canteens provide a welcoming environment for patrons to enjoy delicious meals and foster a sense of community. Whether for a quick bite or a leisurely meal, RD Canteens strive to create memorable dining moments for all.</p>
                        <ul class="py-1">
                            <li><i class="fab fa-instagram"></i><a href="https://www.instagram.com/deepakraj_007/" target="_blank">Developer 1</a></li>
                            <li><i class="fab fa-instagram"></i><a href="https://www.instagram.com/ragul_2003/" target="_blank">Developer 2</a></li>
                        </ul>
                    </article>
                    <!-- Navigation Links -->
                    ...
                    <article class="contact">
                        <ul>
                            ...
                            <li> <i class="fas fa-phone-alt"></i> <p>+91-8610000709</p></li>
                            <li> <i class="fas fa-phone-alt"></i> <p>+91-8668113739</p></li>
                            <li> <i class="fas fa-envelope"></i> <p>rdcanteens@gmail.com</p></li>
                            <li> <i class="fas fa-map-marker-alt"></i> <p>Opp. to KCT College</p></li>
                ...
                <main class="deep-devs flex">
                    <div class="">Designed & Developed with <i class="fas fa-heart clr-red"></i> By <a href="#">Deepak & Ragul Adhithya</a></div>
                </main>
            </section>
        `;
        })
